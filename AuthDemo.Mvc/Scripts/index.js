...
layui.config({
    ...
    function lockPage() {
        layer.open({
            ...
            content: '	<div class="admin-header-lock" id="lock-box">' +
                '<div class="admin-header-lock-img"><img src="/Content/Images/User/Head/admin.jpg"/></div>' +
    ...
    //加载滚动条
    function loadScroll() {
        $("#divLeftNav").niceScroll({ autohidemode: false, cursorcolor: "#333" });
        //$("html").niceScroll({ autohidemode: false, cursorcolor: "#333" });
    }
});
...
//关于芒果中心
function mangguoAbout() {
    layer.tab({
        area: ['260px', '367px'],
        tab: [{
            title: "芒果",
            content: "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><font>芒果系统：v1.0</font></div>"
        }, {
            title: "历史",
                content: "<div style='padding:30px;overflow:hidden;background:#d2d0d0;'><font>还没有发布</font></div>"
        }]
    })
}